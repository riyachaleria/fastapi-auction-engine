...
from services.email_services import send_welcome_email, send_auction_won_email, send_item_sold_email
...
def test_send_auction_won_email_success(mock_smtp):
    send_auction_won_email("winner", "winner@example.com", "Rolex", 500.0)
